		...
		<div class="col-md-8">
			...
			<div class="row">
				...
				<ul class="ul_bot hidden-xs wow fadeInUp">
					...
					<li><h2><a href="{!! route('public.trangchu') !!}">Trang chủ</a></h2></li>

					<li><h2><a href="{!! route('public.gioithieu') !!}">Giới thiệu</a></h2></li>

					<li><h2><a href="{!! route('public.duan') !!}">Dự án</a></h2></li>

					<li><h2><a href="{!! route('public.sangiaodich', ['type' => 1]) !!}">Sàn giao dịch</i></a></h2></li>

					<li><h2><a href="{!! route('public.tintuc.list') !!}">Tin tức</i></a></h2></li>


					<li><h2><a style="border: none;padding-right: 0;" href="{!! route('public.lienhe') !!}">Liên hệ</a></h2></li>
...
<div class="footer_wrapper">
	...
	<div class="container">Copyright © 2012 - Công Ty Cổ Phần Bất Động Sản Đà Nẵng</div>
...
<script type="text/javascript">
	...
	(function(){
		var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
		s1.async=true;
		s1.src='https://embed.tawk.to/5b01a30b227d3d7edc257c69/default';
		s1.charset='UTF-8';
		s1.setAttribute('crossorigin','*');
		s0.parentNode.insertBefore(s1,s0);
	})();
