...
<div class="content_wrapper">
        ...
        <div class="main bg_white clearfix">
            <div class="box register margin-center mt30 mb30">
                ...
                <form class="form-horizontal" role="form" method="post" action="{!! route('public.taotin') !!}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="poster_id" value="{!! $objCustomer->poster->id !!}" />
                    @if (session('error'))
                                            ...
                                            <ul class="clearfix">
                                                ...
                                                <li class="mb20 clearfix">
                                                    ...
                                                    <label class="w-85-100 fl pr13">
                                                        <input name="project" type="text" class="width-full lh20 gray2"/>
                                                    </label>
                                                </li>
                                                <li class="mb20 clearfix">
                                                    ...
                                                    <div class="w-85-100 fl clearfix">
                                                        <label class="fl position w-30-100 mr3-100">
                                                            <input name="price" type="number" id="txtGia" class="width-full txtgia" min="0" max="999"/>
                                                            @if ($errors->has('price'))
                                                        ...
                                                        <div class="mix-select fl position w-30-100 mr10">
                                                            <select name="unit_price_id" id="unitPrice" class="select">
                                                        ...
                                                        <label class="fl position w-30-100 mr10 clearfix">
                                                            <input name="area" type="number" id="dientich" class="txtdientich" min="0" max="10000"/>
                                                            <span>m2
                                                            </span>
                                                            @if ($errors->has('area'))
                                                ...
                                                <li class="mb10 clearfix">
                                                    ...
                                                    <li class="mb20 mt10 clearfix">
                                                        ...
                                                        <label class="w-85-100 fl pr13">
                                                            ...
                                                            <textarea name="description" class="width-full radius" cols="60" rows="5"></textarea>
                                                    ...
                                                    <li class="mb20 clearfix">
                                                        <label class="w-15-100 fl lh35">Thời gian </label>
                                                        <div class="w-85-100 fl pr13 clearfix">
                                                            <div class="date-select  fl position">
                                                                <span class="pd5">Từ:</span><input name="start_time" type="date" value="{!! date('Y-m-d') !!}" class="gray2 show-value lh20 hasDatepicker" onkeypress="return false;">
                                                            ...
                                                            <div class="date-select  fr position">
                                                                <span class="pd5">Đến:</span><input name="end_time" type="date" value="{!! date('Y-m-d') !!}" class="gray2 show-value lh20 hasDatepicker" onkeypress="return false;">
                                                                @if ($errors->has('end_time'))
                                                                <span style="color: red; display: block; font-weight: normal;" id="spanGia">{!! $errors->first('end_time') !!}</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <span class="red">Thời gian bắt đầu phải sau thời gian hiện tại ít nhất một ngày</span>
                                                    </li>
                                                    <li class="mb20 clearfix position">
                                                        ...
                                                        <span style="color: red; display: block; font-weight: normal;">Chọn tối đa 3 hình</span>
                                                        <div class="clear"></div>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="box-cont">
                                                <ul class="clearfix">
                                                    ...
                                                    <li class="mb20 clearfix">
                                                        ...
                                                        <label class="w-60-100 fl">
                                                            <input name="address" type="text" class="width-full lh20 gray2" />
                                                        </label>
                                                    </li>
                                                    <li class="mb20 clearfix">
                                                        <label class="w-40-100 fl lh35">Điện thoại</label>
                                                        <label class="w-60-100 fl">
                                                            <input name="phone" type="text" class="width-full lh20 gray2" />
                                                            @if ($errors->has('phone'))
                                                    ...
                                                    <li class="mb20 clearfix">
                                                        ...
                                                        <label class="w-60-100 fl">
                                                            <input name="email" type="text" class="width-full lh20 gray2" />
                                                            @if ($errors->has('email'))
                                            ...
                                            <div class="box-cont">
                                                <ul class="clearfix">
                                                    <li class="mb20 clearfix">
                                                        ...
                                                        <label class="w-60-100 fl">
                                                            <input name="fontispiece" type="number" min="0" max="10000" class="width-full lh20 gray2" />
                                                        </label>
                                                    </li>
                                                    <li class="mb20 clearfix">
                                                        <label class="w-40-100 fl lh35">Đường trước (m)</label>
                                                        <label class="w-60-100 fl">
                                                            <input name="road_ahead" type="number" min="0" max="10000" class="width-full lh20 gray2" />
                                                        </label>
                                                    </li>
                                                    <li class="mb20 clearfix">
                                                    ...
                                                    <li class="mb20 clearfix">
                                                        ...
                                                        <label class="w-60-100 fl">
                                                            <input name="number_of_floor" type="number" min="0" max="100" class="width-full lh20 gray2" />
                                                        </label>
                                                    </li>
                                                    <li class="mb20 clearfix">
                                                        <label class="w-40-100 fl lh35">Số phòng</label>
                                                        <label class="w-60-100 fl">
                                                            <input name="number_of_room" type="number" min="0" max="100" class="width-full lh20 gray2" /></label>
                                                        </li>
                                                        <li class="mb20 clearfix">
                                                            <label class="w-40-100 fl lh35">Số toilet</label>
                                                            <label class="w-60-100 fl">
                                                                <input name="number_of_toilet" type="number" min="0" max="100" class="width-full lh20 gray2" />
                                                            </label>
                                                        </li>
                                                        <li class="mb20 clearfix">
    ...
    <script type="text/javascript">
        ...
        function changeDistrict() {
            ...
            $.ajax({
                ...
                success : function(result){
                    ...
                    $("#village").html(html);
                    $('#diadiem').val($('#district option:selected').text() + ', Đà Nẵng');
                }
            });
        }
        ...
        function changeVillage() {
            ...
            $.ajax({
                ...
                success : function(result){
                    ...
                    $("#street").html(html);
                    $('#diadiem').val($('#village option:selected').text()  + ', ' + $('#district option:selected').text() + ', Đà Nẵng');
                }
            });
        }
        ...
        function changeStreet() {
            street = $('#street').val();
            if (street != -1) {
                $('#diadiem').val($('#street option:selected').text() + ', ' + $('#village option:selected').text()  + ', ' + $('#district option:selected').text() + ', Đà Nẵng');
                return;
            }
        }
