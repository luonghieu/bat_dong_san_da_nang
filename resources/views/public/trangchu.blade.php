                ...
                <ul id="ns-slider1" class="home_ul owl-carousel owl-theme">
                    ...
                    <li class="col-lg-12 wow fadeInUp">
                        ...
                        <div class="boc">
                            ...
                            <div style="position: relative;overflow: hidden;" class="contai"><a href="{!! route('public.chitietduan', ['id' => $obj->id]) !!}"><img src="{!! asset($obj->image) !!}" alt="{!! asset($obj->name) !!}" class="img-responsive" /></a>

                                <h3 class="ten"><a href="{!! route('public.chitietduan', ['id' => $obj->id]) !!}">{!! asset($obj->name) !!}</a></h3>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6  wow fadeInUp">
                ...
                <a href="{!! route('public.chitiettintuc', ['id' => $obj->id]) !!}"><img src="{!! asset($obj->image) !!}" class="img-responsive immg"/></a>
                ...
                <div class="chitiet"><a href="{!! route('public.chitiettintuc', ['id' => $obj->id]) !!}">Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                ...
                <ul class="ul_news_right">
                    ...
                    <li>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <h6 class="ten3"> <a href="{!! route('public.chitiettintuc', ['id' => $obj->id]) !!}">{!! asset($obj->name) !!}</a></h6>
