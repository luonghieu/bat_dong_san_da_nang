...
<section class="tile">
	...
	<!-- tile body -->
	<form class="form-horizontal" role="form" method="post" action="{!! route('admins.introduce.action') !!}">
				...
				<table class="table table-custom" id="editable-usage">
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td class="actions"><a href="{!! route('admins.introduce.edit',['id' => $obj->id]) !!}" role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Edit</a><a role="button" tabindex="0" class="delete text-danger text-uppercase text-strong text-sm mr-10">Remove</a></td>
						</tr>
						@endforeach
					</tbody>
				</table>
...
<script>
	...
	function active(id) {
		$.ajax({
			url: "{!! route('admins.introduce.active') !!}",
			method: "GET",
			data: {
				'id' : id
			},
