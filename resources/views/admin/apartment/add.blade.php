...
<a href="{{ route('admins.apartment.list', ['productId' => $product->id]) }}">Apartment</a> 
Add Apartment
@endsection
@section('content')
<!-- tile -->
<section class="tile">
	...
	<div class="tile-header dvd dvd-btm">
		<h1 class="custom-font"><strong>Add Apartment</strong></h1>
		<ul class="controls">
			<li>
	...
	<div class="tile-body">
		...
		@endif
		<form role="form" id="form-add" method="post" action="{!! route('admins.apartment.store', ['id' => $product->id]) !!}" enctype="multipart/form-data">
