...
<section class="tile">
	...
	<div class="tile-header dvd dvd-btm">
		...
		<ul class="controls">
			<li>
				<a href="{!! route('admins.product.sale.create') !!}" role="button" tabindex="0" id="add-entry"><i class="fa fa-plus mr-5"></i> Add</a>
			</li>
			<li class="dropdown">
	...
	<!-- tile body -->
	<form class="form-horizontal" role="form" method="post" action="{!! route('admins.product.sale.action') !!}">
				...
				<table class="table table-custom" id="editable-usage">
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td class="actions"><a href="{!! route('admins.product.sale.edit',['id' => $obj->id]) !!}" role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Edit</a><a role="button" tabindex="0" class="delete text-danger text-uppercase text-strong text-sm mr-10">Remove</a></td>
						</tr>
						@endforeach
					</tbody>
				</table>
