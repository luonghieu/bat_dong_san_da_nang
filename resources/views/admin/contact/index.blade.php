...
<section class="tile">
	...
	<div class="tile-header dvd dvd-btm">
		<h1 class="custom-font"><strong>Contact</strong></h1>
		<ul class="controls">
			<li class="dropdown">
	...
	<!-- tile body -->
	<form class="form-horizontal" role="form" method="post" action="{!! route('admins.contact.action') !!}">
...
<script>
	...
	function active(id) {
		$.ajax({
			url: "{!! route('admins.contact.active') !!}",
			method: "GET",
			data: {
				'id' : id
			},
