...
@endsection
@section('title')
<a href="{!! route('admins.project.list') !!}">Project</a> Add Project
@endsection
@section('content')
<!-- tile -->
<section class="tile">
    ...
    <div class="tile-header dvd dvd-btm">
        ...
        <ul class="controls">
            @if (!isEmployee())
            <li>
                <a id="edit" role="button" tabindex="0"><i class="fa fa-plus mr-5"></i> Add</a>
            </li>
            @endif
            <li class="dropdown">
    ...
    <div class="tile-body">
        ...
        @endif
        <form role="form" id="form-project" method="post" action="{!! route('admins.project.store') !!}" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{csrf_token()}}" />
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label"><strong>Name</strong></label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="name" placeholder="Title" value="">
                    @if ($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <div>
                    <textarea class="form-control" id="price_payment" name="price_payment"></textarea>
                    <script>
