...
<section class="tile">
	...
	<!-- tile body -->
	<form class="form-horizontal" role="form" method="post" action="{!! route('admins.product.lease.action') !!}">
				...
				<table class="table table-custom" id="editable-usage">
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td class="actions"><a href="{!! route('admins.product.lease.edit',['id' => $obj->id]) !!}" role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Edit</a><a role="button" tabindex="0" class="delete text-danger text-uppercase text-strong text-sm mr-10">Remove</a></td>
						</tr>
						@endforeach
					</tbody>
				</table>
...
@section('script')
@include('admin.product.lease.script')
<script>
    ...
    function changeStatus(id) {
        ...
        $.ajax({
            url: "{!! route('admins.product.lease.status') !!}",
            method: "GET",
            data: {
                'id' : id,
				'status' : status
